...
type Account interface {
	...
	Transfer(senderID, recipientID, amount int) (sender, recipient models.User, err error)
...
func (acc *account) AddBalance(userID, amount int) (user models.User, err error) {
	...
	if err != nil {
		log.Println("add balance, db operation err:", err)
		return user, err
	}
...
func (acc *account) SubBalance(userID, amount int) (user models.User, err error) {
	...
	if err != nil {
		log.Println("sub balance, db operation err:", err)
		return user, err
	}
